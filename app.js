...
function firstQA() {
    ...
    //Additional
    const array_of_items = ["<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Read brief in SPARC <br>", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Auto filter recipients<br> (if Admin, to be unticked)", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Review import file and its columns", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> From And Reply Address <br>", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Subject line & Preheader", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Footer (if admin campaign = admin footer)", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Layout Desktop (Mobile)<br>(ignore multiple conditions)", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'>Images Published?", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Personalized fields populated with real data<br>", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Links: for T&C, Main CTA <br>", "<input type='checkbox' name='reviewTicketCheckBox' class='reviewTicketCheckBox'> Conditional split % <br>and condition sense check"];
...
function loadStyles() {
    ...
    const modalAlertBox = "#modalWindowForAlert{color:#ffffff;background: #1577e7;position:fixed;left:30%;top:50%;width:500px;word-wrap:break-word;padding:14px;border: 1px solid;box-shadow: inset 0px 0px 2px 3px;}#modalWindowForAlert ul>li{list-style-type:none !important;}#modalWindowForAlert ul{padding:0px;margin:0px;}#closeModalWindowForAlert{position:absolute;right:7px;top:0px;padding:0px;margin:0px;color:red;font-weight:bold;font-size:20px;cursor:pointer;}";
    ...
    style_app.innerHTML = buttonForMC + modalAlertBox + alertBox + appearBox + log_messages + custom_aybe_scrollbar + wiki_styles + jump_window + sparc_number + ul_li + dialog_window + open_close + select_styles + ".ahojky{box-sizing: content-box;overflow-y: scroll;overflow-x: hidden;max-height:350px;box-shadow: 10px 10px 10px rgba(0, 0, 0, 0.5);padding:20px;position:fixed;top:0px;right:0px;width:300px;height:auto;border:3px solid #f4f4f4);background-color:FF3D00;z-index:9999}.ahojky:hover{background-color:rgba(255,255,255,0.8);}" + option_styles;
