...
function loadStyles() {
    ...
    style_app.innerHTML = buttonForMC + modalAlertBox + alertBox + appearBox + log_messages + custom_aybe_scrollbar + wiki_styles + jump_window + sparc_number + ul_li + dialog_window + open_close + select_styles + ".ahojky{box-sizing: content-box;overflow-y: scroll;overflow-x: hidden;max-height:400px;border:solid 2px #f1f1f1;padding:20px;position:fixed;top:0px;right:0px;width:240px;height:auto;border:3px solid #f4f4f4);background-color:FF3D00;z-index:9999}.ahojky:hover{background-color:rgba(255,255,255,0.8);}" + option_styles;
